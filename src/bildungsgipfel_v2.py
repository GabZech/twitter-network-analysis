...
words = "(Bildungsgipfel OR #Bifo2023)" # The words you want tweets to include
...
df = get_retweets_v2(query, tweets_limit)

# get current time and date
now = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")

df.to_csv(f'data/tweets_bildungsgipfel_v2_{now}.csv', index=False)
