...
u = gt.extract_largest_component(g, directed=True) # this appears to be the wrong way to do this, because the subgraph is very small. Maybe it only selects a subgraph which is connected by in and out edges?
